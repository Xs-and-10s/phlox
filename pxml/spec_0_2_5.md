...
- Commandable — 74 bookended commands across 8 control axes give users prompt-time power over every aspect of the pipeline
...
│  73 commands across 8 control axes              │
├──────────────────────┬──────────────────────────┤
...
Children: `<defaults>`, `<state>`, `<prep>`, `<exec>`, `<post>`, `<with>`, `<capability>`
